...
from sqlalchemy import Column, Integer, String, Boolean, ForeignKey, Date, Text, UniqueConstraint, Float, JSON
...
class Detail(Base):
    ...
    __table_args__ = (UniqueConstraint("url", name="uq_detail_url"),)
